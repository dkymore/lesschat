definePlugin(
  '@plugins/com.msgbyte.bbcode/parser-34594393.js',
  ['exports', 'react'],
  function (exports, React) {
    ...
    (function (module, exports) {
      (function (global, factory) {
        ...
        var BACKSLASH_1 =
          (char.BACKSLASH =
          char.PLACEHOLDER_SPACE =
          char.PLACEHOLDER_SPACE_TAB =
          SLASH_1 =
          char.SLASH =
          CLOSE_BRAKET_1 =
          char.CLOSE_BRAKET =
         ...
         */ var escapeHTML = function (value) {
          return value
            ...
            .replace(/>/g, '&gt;')
            .replace(/"/g, '&quot;')
            .replace(/'/g, '&#039;') // eslint-disable-next-line no-script-url
         ...
         */ var attrValue = function (name, value) {
          ...
          var types = {
            ...
            object: function () {
              return ''
                .concat(name, '="')
                .concat(escapeHTML(JSON.stringify(value)), '"');
            },
          };
        ...
        var getTagAttrs = function (tag, params) {
          ...
          if (uniqAattr) {
            ...
            var attrs = _objectSpread({}, params);
            ...
            },
            {
              ...
              value: function toTagStart(param) {
                var ref = param === void 0 ? {} : param,
                  _openTag = ref.openTag,
                  openTag = _openTag === void 0 ? _char.OPEN_BRAKET : _openTag,
                  _closeTag = ref.closeTag,
                  closeTag =
                    _closeTag === void 0 ? _char.CLOSE_BRAKET : _closeTag;
        ...
        TagNode.create = function (tag, param, param1) {
          var attrs = param === void 0 ? {} : param,
            content = param1 === void 0 ? [] : param1;
        ...
        function CharGrabber(source, options) {
          ...
          var prev = function () {
            ...
            return typeof source[prevPos] !== 'undefined'
              ? source[prevPos]
              : null;
          };
          var next = function () {
        ...
        function NodeList(param) {
          ...
          var getLast = function () {
            return Array.isArray(nodes) &&
              nodes.length > 0 &&
              typeof nodes[nodes.length - 1] !== 'undefined'
         ...
         */ function createLexer(buffer, param) {
          ...
          var stateTag = function stateTag() {
            ...
            if (currChar === openTag) {
              ...
              var hasInvalidChars =
                substr.length === 0 || substr.indexOf(openTag) >= 0;
              if (
                isCharReserved(nextChar) ||
                hasInvalidChars ||
                chars.isLast()
              ) {
          ...
          var WHITESPACES = [SPACE_1, TAB_1];
          var SPECIAL_CHARS = [EQ_1, SPACE_1, TAB_1];
          ...
          var isEscapableChar = function (char) {
            return (
              char === openTag || char === closeTag || char === BACKSLASH_1
            );
          };
         ...
         */ var parse = function (input, param) {
           ...
           */ var isTokenNested = function (token) {
            ...
            if (
              !nestedTagsMap.has(value) &&
              tokenizer.isTokenNested &&
              tokenizer.isTokenNested(token)
            ) {
           ...
           */ var handleTagEnd = function (token) {
            ...
            if (lastNestedNode) {
              ...
              options.onError({
                message: "Inconsistent tag '"
                  .concat(tag, "' on line ")
                  .concat(line, ' and column ')
                  .concat(column),
                tagName: tag,
                lineNumber: line,
                columnNumber: column,
          ...
          tokenizer = (
            opts.createTokenizer ? opts.createTokenizer : createLexer
          )(input, {
            onToken: onToken,
    ...
    function assignValue$1(object, key, value) {
      ...
      if (
        !(hasOwnProperty$9.call(object, key) && eq$2(objValue, value)) ||
    ...
    if (
      (DataView &&
        getTag$3(new DataView(new ArrayBuffer(1))) != dataViewTag$2) ||
      ...
      preProcessText(input, processFn) {
        ...
        return ast
          .map((node, index) => {
            ...
            const attrsStr = toPairs_1(attrs)
              .map(([key, value]) => {
                if (key === value) {
                  return `="${value}"`;
                } else {

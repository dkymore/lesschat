definePlugin(
  '@plugins/com.msgbyte.draw/DrawModal-1bcff596.js',
  [
    'exports',
    '@capital/common',
    '@capital/component',
  ...
  function (exports, common, component, React, index$1) {
    'use strict';
    ...
    Object.defineProperty(Point$3, '__esModule', {
      value: true,
    });
    ...
    Point$3.default = Point$2;

    Object.defineProperty(LazyPoint$1, '__esModule', {
      value: true,
    });
    ...
    var _Point2$3 = Point$3;

    var _Point3 = _interopRequireDefault$4(_Point2$3);
    ...
    var LazyPoint = (function (_Point) {
      ...
      function LazyPoint() {
        _classCallCheck$3(this, LazyPoint);

        return _possibleConstructorReturn(
          this,
          (LazyPoint.__proto__ || Object.getPrototypeOf(LazyPoint)).apply(
            this,
            arguments
          )
        );
    ...
    LazyPoint$1.default = LazyPoint;

    Object.defineProperty(LazyBrush$2, '__esModule', {
      value: true,
    });
    ...
    var _LazyPoint$1 = LazyPoint$1;

    var _LazyPoint2$1 = _interopRequireDefault$3(_LazyPoint$1);
    ...
    var LazyBrush$1 = (function () {
      ...
      function LazyBrush() {
        var _ref =
          ...
          initialPoint =
            _ref$initialPoint === undefined
              ? { x: 0, y: 0 }
              : _ref$initialPoint;

        _classCallCheck$2(this, LazyBrush);

        this.radius = radius;
        this._isEnabled = enabled;

        this.pointer = new _LazyPoint2$1.default(
          initialPoint.x,
          initialPoint.y
        );
        this.brush = new _LazyPoint2$1.default(initialPoint.x, initialPoint.y);
    ...
    LazyBrush$2.default = LazyBrush$1;

    Object.defineProperty(lib$1, '__esModule', {
      value: true,
    });
    lib$1.LazyPoint = lib$1.Point = LazyBrush = lib$1.LazyBrush = undefined;

    var _LazyBrush = LazyBrush$2;

    var _LazyBrush2 = _interopRequireDefault$2(_LazyBrush);

    var _Point$2 = Point$3;

    var _Point2$2 = _interopRequireDefault$2(_Point$2);

    var _LazyPoint = LazyPoint$1;

    var _LazyPoint2 = _interopRequireDefault$2(_LazyPoint);

    function _interopRequireDefault$2(obj) {
      return obj && obj.__esModule ? obj : { default: obj };
    }

    var LazyBrush = (lib$1.LazyBrush = _LazyBrush2.default);
    lib$1.Point = _Point2$2.default;
    lib$1.LazyPoint = _LazyPoint2.default;
    ...
    Object.defineProperty(Point$1, '__esModule', {
      value: true,
    });
    ...
    Object.defineProperty(Catenary$2, '__esModule', {
      value: true,
    });
    ...
    var _Point$1 = Point$1;

    var _Point2$1 = _interopRequireDefault$1(_Point$1);
    ...
    var Catenary$1 = (function () {
      ...
      function Catenary() {
        var _ref =
          ...
          iterationLimit =
            _ref$iterationLimit === undefined ? 100 : _ref$iterationLimit;

        _classCallCheck(this, Catenary);

        this.p1 = new _Point2$1.default();
        this.p2 = new _Point2$1.default();
          ...
          value: function drawToCanvas(context, point1, point2, chainLength) {
            ...
            if (distance < chainLength) {
              ...
              if (diff > 0.01) {
                var h = p2.x - p1.x;
                var v = p2.y - p1.y;
                var a = -this.getCatenaryParameter(
                  h,
                  v,
                  chainLength,
                  this.iterationLimit
                ...
                var x =
                  (a * Math.log((chainLength + v) / (chainLength - v)) - h) *
                  0.5;
                var y = a * Math.cosh(x / a);
                var offsetX = p1.x - x;
                var offsetY = p1.y - y;
                curveData = this.getCurve(
                  a,
                  p1,
                  p2,
                  offsetX,
    ...
    Catenary$2.default = Catenary$1;

    Object.defineProperty(lib, '__esModule', {
      value: true,
    });
    lib.Point = Catenary = lib.Catenary = undefined;

    var _Catenary = Catenary$2;
    ...
    var Catenary = (lib.Catenary = _Catenary2.default);
    lib.Point = _Point2.default;
    ...
    var CoordinateSystem = /*#__PURE__*/ (function () {
      ...
      function CoordinateSystem(_ref) {
        ...
        _defineProperty$2(this, '_scaleExtents', void 0);

        _defineProperty$2(this, '_documentSize', void 0);

        _defineProperty$2(this, '_canvas', null);

        _defineProperty$2(this, '_view', {
          scale: 1.0,
          x: 0,
          y: 0,
        });

        _defineProperty$2(this, '_viewChangeListeners', new Set());

        _defineProperty$2(this, 'setScale', function (scale) {
          _this.setView({
            scale: scale,
          });
        });

        _defineProperty$2(this, 'clampView', function (_ref2) {
        ...
        _defineProperty$2(this, 'resetView', function () {
          _this.setView({
            scale: 1.0,
            x: 0,
            y: 0,
        ...
        _defineProperty$2(this, 'setView', function (view) {
          var newView = _this.clampView(
            _extends$1({}, _this._view, view || {})
          );
          ...
          return _extends$1({}, _this._view);
        });

        _defineProperty$2(
          this,
          'scaleAtClientPoint',
          function (deltaScale, clientPoint) {
            var viewPt = _this.clientPointToViewPoint(clientPoint);

            var newView = _this.clampView(
              _extends$1({}, _this._view, {
                scale: _this._view.scale + deltaScale,
              })
            );

            var clientPtPostScale = _this.viewPointToClientPoint(
              viewPt,
              newView
            );

            newView.x =
              _this._view.x - (clientPtPostScale.clientX - clientPoint.clientX);
            newView.y =
              _this._view.y - (clientPtPostScale.clientY - clientPoint.clientY);
      ...
      _createClass(CoordinateSystem, [
        ...
        },
        {
          key: 'scaleExtents',
          get: function get() {
            return _extends$1({}, this._scaleExtents);
          },
          /**
        ...
        },
        {
          key: 'documentSize',
          get: function get() {
            return _extends$1({}, this._documentSize);
          },
          /**
    ...
    var DefaultState = function DefaultState() {
      ...
      _defineProperty$1(this, 'handleMouseWheel', function (e, canvasDraw) {
      ...
      _defineProperty$1(this, 'handleDrawStart', function (e, canvasDraw) {
      ...
      _defineProperty$1(this, 'handleDrawMove', function (e, canvasDraw) {
        if (canvasDraw.props.disabled) {
          return new DisabledState();
        } else {
          var _viewPointFromEvent = viewPointFromEvent(
              canvasDraw.coordSystem,
              e
            ),
      ...
      _defineProperty$1(this, 'handleDrawEnd', function (e, canvasDraw) {
    ...
    var PanState = function PanState() {
      ...
      _defineProperty$1(this, 'handleMouseWheel', SUPPRESS_SCROLL.bind(this));
      ...
      _defineProperty$1(this, 'handleDrawEnd', function () {
    ...
    var WaitForPinchState = function WaitForPinchState() {
      ...
      _defineProperty$1(this, 'handleDrawMove', function (e, canvasDraw) {
        ...
        if (new Date().valueOf() - _this5.startTimestamp < PINCH_TIMEOUT_MS) {
          ...
          var d =
            Math.abs(clientPt.clientX - _this5.startClientPoint.clientX) +
            Math.abs(clientPt.clientY - _this5.startClientPoint.clientY);
      ...
      _defineProperty$1(this, 'issueDeferredPoints', function (canvasDraw) {
    ...
    var ScaleOrPanState = function ScaleOrPanState() {
      ...
      _defineProperty$1(this, 'handleDrawMove', function (e, canvasDraw) {
        ...
        var _this6$recentMetrics = (_this6.recentMetrics =
            _this6.getTouchMetrics(e)),
      ...
      _defineProperty$1(this, 'getTouchMetrics', function (e) {
    ...
    var TouchPanState = function TouchPanState(scaleOrPanState) {
      ...
      _defineProperty$1(this, 'handleDrawStart', function () {
        return _this7;
      });
    ...
    var DrawingState = function DrawingState() {
      ...
      _defineProperty$1(this, 'handleDrawStart', function (e, canvasDraw) {
        ...
        if (e.touches && e.touches.length) {
          ...
          var _viewPointFromEvent2 = viewPointFromEvent(
              canvasDraw.coordSystem,
              e
            ),
      ...
      _defineProperty$1(this, 'handleDrawMove', function (e, canvasDraw) {
        ...
        var _viewPointFromEvent3 = viewPointFromEvent(
            canvasDraw.coordSystem,
            e
          ),
    ...
    var SyntheticEvent = function SyntheticEvent(_ref) {
      ...
      _defineProperty$1(this, 'preventDefault', function () {});
    ...
    var CanvasDraw = /*#__PURE__*/ (function (_PureComponent) {
      ...
      function CanvasDraw(props) {
        ...
        _defineProperty(
          _assertThisInitialized(_this),
          'getDataURL',
          function (fileType, useBgImage, backgroundColour) {
        ...
        _defineProperty(
          ...
          function () {
            ...
            _this.canvas['interface'] &&
              _this.canvas['interface'].removeEventListener(
                'wheel',
                _this.handleWheel
              );
          }
        ...
        _defineProperty(
          ...
          'handleWheel',
          function (e) {
            _this.interactionSM = _this.interactionSM.handleMouseWheel(
              e,
              _assertThisInitialized(_this)
            );
          }
        ...
        _defineProperty(
          ...
          'handleDrawStart',
          function (e) {
            _this.interactionSM = _this.interactionSM.handleDrawStart(
              e,
              _assertThisInitialized(_this)
            );
        ...
        _defineProperty(
          ...
          'handleDrawMove',
          function (e) {
            _this.interactionSM = _this.interactionSM.handleDrawMove(
              e,
              _assertThisInitialized(_this)
            );
            _this.mouseHasMoved = true;
        ...
        _defineProperty(
          ...
          'handleDrawEnd',
          function (e) {
            _this.interactionSM = _this.interactionSM.handleDrawEnd(
              e,
              _assertThisInitialized(_this)
            );
            _this.mouseHasMoved = true;
        ...
        _defineProperty(
          ...
          function (entries) {
            ...
            try {
              for (
                var _iterator = _createForOfIteratorHelperLoose(entries), _step;
        ...
        _defineProperty(
          ...
          function (_ref2) {
            ...
            for (var i = 1, len = points.length; i < len; i++) {
              ...
              _this.ctx.temp.quadraticCurveTo(
                p1.x,
                p1.y,
                midPoint.x,
                midPoint.y
        ...
        _defineProperty(
          ...
          function (_temp) {
            ...
            _this.inClientSpace(
              [_this.ctx.drawing, _this.ctx.temp],
              function () {
                _this.ctx.drawing.drawImage(
                  _this.canvas.temp,
                  0,
                  0,
        ...
        _defineProperty(
          ...
          function () {
            _this.props.onChange &&
              _this.props.onChange(_assertThisInitialized(_this));
          }
        );
        ...
        _this.coordSystem.attachViewChangeListener(
          _this.applyView.bind(_assertThisInitialized(_this))
        );
    ...
    const DrawModal = React__default['default'].memo(
      ({ actions, onSuccess }) => {
        const sendMsg = actions.sendMsg;
        const drawRef = React.useRef(null);
        const [{ loading }, handleSend] = common.useAsyncFn(async () => {
          const dataUrl = drawRef.current.getDataURL();
          const file = common.dataUrlToFile(dataUrl);
          const res = await common.uploadFile(file);
          sendMsg(
            common
              .getMessageTextDecorators()
              .image(res.url, { width: 400, height: 400 })
          );
          onSuccess();
        }, [sendMsg, onSuccess]);
        return /* @__PURE__ */ React__default['default'].createElement(
          'div',
          null,
          /* @__PURE__ */ React__default['default'].createElement(CanvasDraw, {
            ref: drawRef,
          }),
...
//# sourceMappingURL=DrawModal-1bcff596.js.map

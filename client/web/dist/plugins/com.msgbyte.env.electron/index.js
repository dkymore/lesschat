definePlugin(
  '@plugins/com.msgbyte.env.electron',
  ['require', '@capital/common', '@capital/component', 'react'],
  function (require, common, component, React) {
    'use strict';
    ...
    const Translate = {
      ...
      nativeWebviewRenderDesc: common.localTrans({
        'zh-CN':
          '\u89E3\u9664\u9ED8\u8BA4\u7F51\u9875\u8BBF\u95EE\u9650\u5236\uFF0C\u5141\u8BB8\u5728Tailchat\u5D4C\u5165\u4EFB\u610F\u7F51\u7AD9\u5185\u5BB9',
        'en-US':
    ...
    async function checkUpdate() {
      ...
      const [semver, config] = await Promise.all([
        new Promise(function (resolve, reject) {
          require(['./index-55d1c82a'], resolve, reject);
        }).then(function (n) {
          return n.index;
        }),
      ...
      const latestVersion =
        latestConfig == null ? void 0 : latestConfig.version;
      ...
      if (semver.gt(latestVersion, version)) {
        component.notification.info({
          ...
          btn: /* @__PURE__ */ React__default['default'].createElement(
            component.Button,
            {
              type: 'primary',
              onClick: () => {
      ...
      return /* @__PURE__ */ React__default['default'].createElement(
        ...
        isVisiable === false &&
          /* @__PURE__ */ React__default['default'].createElement(
            'span',
            null,
            Translate.nativeWebviewRenderHideTip
          )
      );
    });
    ...
    navigator.mediaDevices.getDisplayMedia = async (options) => {
      const source =
        await window.electron.ipcRenderer.getDesktopCapturerSource();

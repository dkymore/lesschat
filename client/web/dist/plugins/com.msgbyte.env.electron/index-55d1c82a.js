definePlugin(
  '@plugins/com.msgbyte.env.electron/index-55d1c82a.js',
  ['exports'],
  function (exports) {
    'use strict';
    ...
    class SemVer$f {
      constructor(version, options) {
        ...
        const m = version
          .trim()
          .match(options.loose ? re$3[t$3.LOOSE] : re$3[t$3.FULL]);
    ...
    class Range$b {
      ...
      parseRange(range) {
        ...
        const comparators = rangeList.map(
          (comp) => new Comparator$4(comp, this.options)
        );

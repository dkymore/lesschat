definePlugin(
  '@plugins/com.msgbyte.intro/tour-a10b7cf3.js',
  ['@capital/common'],
  function (common) {
    'use strict';
    ...
    const limitShift = function limitShift(options) {
      ...
      return {
        ...
        fn(state) {
          ...
          let crossAxisCoord = coords[crossAxis];
          const rawOffset =
            typeof offset === 'function' ? offset(state) : offset;
    ...
    function getBoundingClientRect(
      ...
      const addVisualOffsets =
        isClientRectVisualViewportBased() && isFixedStrategy;
      let x =
        (clientRect.left +
          (addVisualOffsets
            ? ((_win$visualViewport = win.visualViewport) == null
                ? void 0
                : _win$visualViewport.offsetLeft) || 0
            : 0)) /
        scale.x;
      let y =
        (clientRect.top +
          (addVisualOffsets
            ? ((_win$visualViewport2 = win.visualViewport) == null
                ? void 0
                : _win$visualViewport2.offsetTop) || 0
            : 0)) /
        scale.y;
    ...
    function init(
      ...
      $$.ctx = instance
        ? instance(component, options.props || {}, function (i, ret) {
            const value = (arguments.length <= 2 ? 0 : arguments.length - 2)
              ? arguments.length <= 2
                ? undefined
                : arguments[2]
              : ret;
      ...
      return {
        c() {
          ...
          attr(
            button,
            'aria-label',
            (button_aria_label_value = /*label*/ ctx[3]
              ? /*label*/ ctx[3]
              : null)
          );
          attr(
    ...
    function create_if_block_1$1(ctx) {
      ...
      return {
        ...
        p(ctx, dirty) {
          ...
          if (dirty & /*title*/ 4)
            shepherdtitle_changes.title = /*title*/ ctx[2];
    ...
    function create_if_block$2(ctx) {
      ...
      return {
        ...
        p(ctx, dirty) {
          ...
          if (dirty & /*step*/ 2)
            shepherdcancelicon_changes.step = /*step*/ ctx[1];
    ...
    function create_fragment$1(ctx) {
      ...
      let div_levels = [
        ...
        {
          'aria-labelledby': (div_aria_labelledby_value = /*step*/ ctx[4]
            .options.title
            ? /*labelId*/ ctx[3]
            : null),
        },
      ...
      return {
        ...
        p(ctx, _ref) {
          ...
          if (dirty & /*step*/ 16)
            shepherdcontent_changes.step = /*step*/ ctx[4];
              ...
              (!current ||
                (dirty & /*step, labelId*/ 24 &&
                  div_aria_labelledby_value !==
                    (div_aria_labelledby_value = /*step*/ ctx[4].options.title
                      ? /*labelId*/ ctx[3]
                      : null))) && {
...
Z`;
    ...
    function buildWatchDom(selector) {
      return () => {
    ...
    const steps = [
      {
        ...
        beforeShowPromise: buildWatchDom('[data-tc-role=navbar]'),
      },
      buildStepOption({
        id: 'navbar',
...
//# sourceMappingURL=tour-a10b7cf3.js.map

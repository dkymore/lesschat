definePlugin(
  '@plugins/com.msgbyte.biggerfont',
  ['@capital/common'],
  function (common) {
    'use strict';

    const PLUGIN_ID = 'com.msgbyte.biggerfont';
    const PLUGIN_CONFIG = `${PLUGIN_ID}.config`;
    ...
    const Translate = {
      ...
      default: common.localTrans({
        'zh-CN': '\u9ED8\u8BA4',
        'en-US': 'Default',
      }),
      md: common.localTrans({ 'zh-CN': '\u4E2D\u53F7', 'en-US': 'Middle' }),
      lg: common.localTrans({
        'zh-CN': '\u5927\u53F7',
        'en-US': 'Large',
      }),
      xl: common.localTrans({
        'zh-CN': '\u7279\u5927\u53F7',
        'en-US': 'Extra Large',
      }),
    };
    ...
    function updateFontsize(settings) {
      const fontSize = get_1(settings, PLUGIN_CONFIG);

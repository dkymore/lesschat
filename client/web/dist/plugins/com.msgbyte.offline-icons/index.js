definePlugin('@plugins/com.msgbyte.offline-icons', ['@capital/component'], (function (component) { 'use strict';
  ...
  icons.forEach((collection) => {
    if (!component.Icon.addCollection) {
      console.warn("Cannot call addCollection because of Icon.addCollection has not exposed!");
      return;
    }
    component.Icon.addCollection(collection);
  });

definePlugin(
  '@plugins/com.msgbyte.theme.genshin',
  ['require', '@capital/common'],
  function (require, common) {
    ...
    common.sharedEvent.on('loadColorScheme', (colorSchemeName) => {
      if (colorSchemeName === 'light+genshin-hutao') {
        ...
        new Promise(function (resolve, reject) {
          require(['./theme-71d5be73'], resolve, reject);
        });
      }
    });
  }

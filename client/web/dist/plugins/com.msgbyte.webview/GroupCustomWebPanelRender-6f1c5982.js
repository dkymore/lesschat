definePlugin(
  '@plugins/com.msgbyte.webview/GroupCustomWebPanelRender-6f1c5982.js',
  [
    'exports',
    'react',
    './index-2a3da658',
  ...
  function (exports, React, index, common, component, styled) {
    'use strict';
...
`;
    const xss = new lib$1.exports.FilterXSS({
      css: false,
      whiteList: __spreadProps(
        __spreadValues({}, lib$1.exports.getDefaultWhiteList()),
        { iframe: ['src', 'style', 'class'] }
      ),
      onIgnoreTag: function (tag, html, options) {
    ...
    const GroupCustomWebPanelEditor = React__default['default'].memo(
      (props) => {
          ...
          render: (dataMap) => {
            ...
            return /* @__PURE__ */ React__default['default'].createElement(
              GroupCustomWebPanelRender,
              {
                html:
                  (_d =
                    (_c = dataMap['html']) != null
                      ? _c
                      : (_b =
                          (_a = props.panelInfo) == null ? void 0 : _a.meta) ==
                        null
                      ? void 0
                      : _b.html) != null
                    ? _d
...
//# sourceMappingURL=GroupCustomWebPanelRender-6f1c5982.js.map

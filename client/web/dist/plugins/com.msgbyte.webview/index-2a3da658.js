definePlugin(
  '@plugins/com.msgbyte.webview/index-2a3da658.js',
  ['require', 'exports', '@capital/common'],
  function (require, exports, common) {
    'use strict';

    const Translate = {
      webpanel: common.localTrans({
        'zh-CN': '\u7F51\u9875\u9762\u677F',
        'en-US': 'Webview Panel',
      }),
      ...
      editTip: common.localTrans({
        'zh-CN':
          '\u4F7F\u7528html\u8BED\u6CD5\u7F16\u8F91, \u5173\u95ED\u7A97\u53E3\u81EA\u52A8\u4FDD\u5B58',
        'en-US':
          'Edit with html syntax, close the window and save automatically',
      }),
    };
      ...
      render: common.Loadable(
        () =>
          new Promise(function (resolve, reject) {
            require(['./GroupWebPanelRender-583474e0'], resolve, reject);
          })
      ),
      menus: [
        {
          ...
          onClick: (panelInfo) => {
            ...
            if ((_a = panelInfo.meta) == null ? void 0 : _a.url) {
              window.open(
                String((_b = panelInfo.meta) == null ? void 0 : _b.url)
              );
            }
          },
        },
    ...
    common.regGroupPanel({
      ...
      render: common.Loadable(
        () =>
          new Promise(function (resolve, reject) {
            require(['./GroupCustomWebPanelRender-6f1c5982'], resolve, reject);
          }),
        {

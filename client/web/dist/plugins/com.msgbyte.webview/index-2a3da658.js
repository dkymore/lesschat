definePlugin('@plugins/com.msgbyte.webview/index-2a3da658.js', ['require', 'exports', '@capital/common'], (function (require, exports, common) { 'use strict';
  ...
  const Translate = {
    ...
    addBackground: common.localTrans({
      "zh-CN": "\u6DFB\u52A0\u80CC\u666F\u8272",
  ...
  common.regGroupPanel({
    ...
    render: common.Loadable(() => new Promise(function (resolve, reject) { require(['./GroupWebPanelRender-583474e0'], resolve, reject); })),
    menus: [
      {
  ...
  common.regGroupPanel({
    ...
    provider: PLUGIN_NAME,
    render: common.Loadable(() => new Promise(function (resolve, reject) { require(['./GroupCustomWebPanelRender-6f1c5982'], resolve, reject); }), {
...
//# sourceMappingURL=index-2a3da658.js.map

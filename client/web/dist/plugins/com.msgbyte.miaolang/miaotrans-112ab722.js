definePlugin(
  '@plugins/com.msgbyte.miaolang/miaotrans-112ab722.js',
  ['exports', './index-f914e0eb', '@capital/common'],
  function (exports, index, common) {
    'use strict';
    ...
    var addPunctuations = function (t, options) {
      var _a = options !== null && options !== void 0 ? options : {},
        _b = _a.calls,
        calls = _b === void 0 ? '喵' : _b,
        _c = _a.halfwidthSymbol,
        halfwidthSymbol = _c === void 0 ? false : _c;
      var a = t.split('');
      var idx = 0;
      while (idx < a.length) {

definePlugin(
  '@plugins/com.msgbyte.env.rn',
  ['@capital/common', 'react'],
  function (common, React) {
    'use strict';
    ...
    forwardSharedEvent('receiveUnmutedMessage', async (payload) => {
      ...
      const [userInfo, scopeName] = await Promise.all([
        ...
        message.groupId
          ? common.getCachedBaseGroupInfo(message.groupId).then((d) => d.name)
          : Promise.resolve(Translate.dm),
      ]);
      const nickname =
        (_b = userInfo == null ? void 0 : userInfo.nickname) != null ? _b : '';
      const icon =
        (_c = userInfo == null ? void 0 : userInfo.avatar) != null
          ? _c
          : void 0;

definePlugin(
  '@plugins/com.msgbyte.openapi/Profile-a7f50739.js',
  [
    'exports',
    './index-c235bf17',
    'react',
...
`;
    const Profile = React__default['default'].memo(() => {
      const { appId, appSecret, appName, appDesc, appIcon } =
        index.useOpenAppInfo();
      const { handleSetAppInfo, handleDeleteApp } =
        useOpenAppAction.useOpenAppAction();
      return /* @__PURE__ */ React__default['default'].createElement(
        ...
        /* @__PURE__ */ React__default['default'].createElement(
          'h2',
          null,
          index$1.Translate.app.basicInfo
        ),
        /* @__PURE__ */ React__default['default'].createElement(
          TwoColumnContainer,
          null,

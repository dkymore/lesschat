definePlugin(
  '@plugins/com.msgbyte.openapi/index-c235bf17.js',
  [
    'require',
    'exports',
    'react',
  ...
  function (require, exports, React, common, component, index$1, styled) {
    'use strict';
...
`;
    const Profile = common.Loadable(
      () =>
        new Promise(function (resolve, reject) {
          require(['./Profile-a7f50739'], resolve, reject);
        })
    );
    const Bot = common.Loadable(
      () =>
        new Promise(function (resolve, reject) {
          require(['./Bot-fd349a49'], resolve, reject);
        })
    );
    const Webpage = common.Loadable(
      () =>
        new Promise(function (resolve, reject) {
          require(['./Webpage-e886a99c'], resolve, reject);
        })
    );
    const OAuth = common.Loadable(
      () =>
        new Promise(function (resolve, reject) {
          require(['./OAuth-d1236498'], resolve, reject);
        })
    );
    ...
    const schema = common.createFastFormSchema({
      appName: common.fieldSchema
        .string()
        .required(index$1.Translate.appNameCannotBeEmpty)
        .max(20, index$1.Translate.appNameTooLong),
    ...
    const CreateOpenApp = React__default['default'].memo((props) => {
      const handleSubmit = async (values) => {
        ...
        try {
          ...
          common.showToasts(
            index$1.Translate.createApplicationSuccess,
            'success'
          );
          ...
          appInfo
            ...
            : /* @__PURE__ */ React__default['default'].createElement(
                ...
                /* @__PURE__ */ React__default['default'].createElement(
                  ...
                  index$1.Translate.createApplication
                ),
                /* @__PURE__ */ React__default['default'].createElement(
                  component.Table,
                  {

definePlugin(
  '@plugins/com.msgbyte.music',
  ['require', '@capital/common', '@capital/component'],
  function (require, common, component) {
    'use strict';
      ...
      render: component.Loadable(
        () =>
          new Promise(function (resolve, reject) {
            require(['./MusicPanel-fd27dac4'], resolve, reject);
          }).then((module) => module.MusicPanel),
        {

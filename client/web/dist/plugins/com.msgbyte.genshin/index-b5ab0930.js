definePlugin(
  '@plugins/com.msgbyte.genshin/index-b5ab0930.js',
  [
    'exports',
    'react',
    './index-e0f14c29',
  ...
  function (exports, React$2, index, require$$1, common, component, styled) {
    'use strict';
	...
	***************************************************************************** */
    ...
    getGachaData$1.getOfficialGachaPool =
      getGachaData$1.getGachaData =
      getGachaData$1.getGachaIndex =
        void 0;
    ...
    async function getGachaData(id) {
      return (await axios_1.default.get(`${API_ENDPOINT}/${id}/zh-cn.json`))
        .data;
    }
    ...
    Object.defineProperty(poolStructureConverter$1, '__esModule', {
      value: true,
    });
    ...
    function poolStructureConverter(data) {
      ...
      data.r5_prob_list.forEach((item) => {
        ...
        item.is_up === 1
          ? pool.upSSR.push(gachaItem)
          : pool.ssr.push(gachaItem);
      });
      // 4*
    ...
    ).reduce(function (accumulator, standardName) {
      ...
      for (var i = 0, len = nodes.length; i < len; i++) {
        ...
        if (node.type === 'text') {
          ...
          if (
            isWhitespace &&
            node.parent &&
            !canTextBeChildOfNode(node.parent)
          ) {
...
`;
    ...
    const WishResultText = React__default['default'].memo(
      ({ label, items, withCount }) => {
        if (items.length === 0) {
          return null;
        }
        return /* @__PURE__ */ React__default['default'].createElement(
    ...
    function useWish(poolData) {
      ...
      const gachaKit = React$2.useMemo(() => {
        return poolData
          ? new lib$3.GenshinGachaKit(
              lib$3.util.poolStructureConverter(poolData)
            )
          : null;
      }, [poolData]);
      const handleGacha = React$2.useCallback(
        (num) => {
          if (!gachaKit) {
            return;
          }
    ...
    function baseIsEqualDeep$1(
      ...
      if (!(bitmask & COMPARE_PARTIAL_FLAG$2)) {
        var objIsWrapped =
            objIsObj && hasOwnProperty$1.call(object, '__wrapped__'),
          othIsWrapped =
            othIsObj && hasOwnProperty$1.call(other, '__wrapped__');
    ...
    const GenshinPanel = React__default['default'].memo(() => {
      ...
      return /* @__PURE__ */ React__default['default'].createElement(
        ...
        /* @__PURE__ */ React__default['default'].createElement(
          ...
          index.Translate.genshin,
          ' - ',
          index.Translate.gacha
        ),
        loading &&
          /* @__PURE__ */ React__default['default'].createElement(

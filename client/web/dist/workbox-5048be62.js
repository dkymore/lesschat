define(['exports'], function (t) {
  ...
  function L(t) {
    return t !== IDBDatabase.prototype.transaction ||
      ...
      ? (
        ...
        ? function (...e) {
            return t.apply(C(this), e), I(v.get(this));
          }
        : function (...e) {
      ...
      : function (e, ...s) {
          ...
          return q.set(n, e.sort ? e.sort() : [e]), I(n);
        };
  }
  function E(t) {
  ...
  function I(t) {
    ...
    const e = E(t);
    return e !== t && (D.set(t, e), U.set(e, t)), e;
  }
  const C = (t) => U.get(t);
  ...
  class j {
    ...
    l(t) {
      const e = t.createObjectStore(M, { keyPath: 'id' });
    ...
    async setTimestamp(t, e) {
      const s = {
        ...
        n = (await this.getDb()).transaction(M, 'readwrite', {
          durability: 'relaxed',
        });
    ...
    async expireEntries(t, e) {
      ...
      const a = [];
      for (const t of i) await s.delete(M, t.id), a.push(t.url);
      return a;
    }
    g(t) {
      return this.u + '|' + T(t);
  ...
  class W {
    ...
    async expireEntries() {
      if (this.m) return void (this.R = !0);
      this.m = !0;
      const t = this.q ? Date.now() - 1e3 * this.q : 0,
        e = await this.U.expireEntries(t, this.v),
        s = await self.caches.open(this.u);
      for (const t of e) await s.delete(t, this.D);
      (this.m = !1), this.R && ((this.R = !1), d(this.expireEntries()));
    }
    ...
    async delete() {
      (this.R = !1), await this.U.expireEntries(1 / 0);
    }
  }
  function P(t, e) {
    const s = new URL(t);
  ...
  class A {
    constructor(t, e) {
      (this._ = {}),
        ...
        (this.O = [...t.plugins]),
        (this.N = new Map());
      for (const t of this.O) this.N.set(t, {});
      this.event.waitUntil(this.I.promise);
    }
    async fetch(t) {
      const { event: e } = this;
      let n = K(t);
    ...
    *iterateCallbacks(t) {
    ...
    waitUntil(t) {
      return this.C.push(t), t;
    }
    async doneWaiting() {
      let t;
      for (; (t = this.C.shift()); ) await t;
    }
    destroy() {
      this.I.resolve(null);
    }
  ...
  class F {
    ...
    async k(t, e, n) {
      ...
      try {
        if (((i = await this.T(e, t)), !i || 'error' === i.type))
  ...
  class H {
    constructor(t = {}) {
      (this.j = t.statuses), (this.W = t.headers);
    }
    isResponseCacheable(t) {
      let e = !0;
      return (
        this.j && (e = this.j.includes(t.status)),
        this.W &&
          e &&
          (e = Object.keys(this.W).some((e) => t.headers.get(e) === this.W[e])),
        e
      );
    }
  }
  ...
  function J(t) {
    ...
    return i.searchParams.set(V, e), { cacheKey: i.href, url: r.href };
  }
  class Q {
    constructor() {
      (this.updatedURLs = []),
        ...
        });
      {
        ...
        (n = await e.fetch(
          ...
          s &&
            a &&
            'no-cors' !== t.mode &&
            (this.F(), await e.cachePut(t, n.clone()));
      }
      return n;
    }
    async K(t, e) {
  ...
  class et {
    constructor({
      ...
      (this.H = new Map()),
        ...
        (this.L = new tt({
          cacheName: f(t),
          plugins: [...e, new z({ precacheController: this })],
          fallbackToNetwork: s,
        })),
    ...
    addToCacheList(t) {
      ...
      for (const n of t) {
        ...
        const { cacheKey: t, url: i } = J(n),
          r = 'string' != typeof n && n.revision ? 'reload' : 'default';
        if (this.H.has(i) && this.H.get(i) !== t)
        ...
        if ((this.H.set(i, t), this.$.set(i, r), e.length > 0)) {
  ...
  (t.CacheFirst = class extends F {
    ...
    (t.CacheableResponsePlugin = class {
      constructor(t) {
        (this.cacheWillUpdate = async ({ response: t }) =>
          this.J.isResponseCacheable(t) ? t : null),
          (this.J = new H(t));
      }
    }),
    (t.ExpirationPlugin = class {
      ...
      Y(t) {
        ...
        let e = this.tt.get(t);
        return e || ((e = new W(t, this.Z)), this.tt.set(t, e)), e;
      }
      X(t) {
        if (!this.q) return !0;
        const e = this.et(t);
